...
4. Wait for the launcher to print/write the ready JSON, verify the port is listening if needed, then send the generated `upload_url` to the user immediately.
